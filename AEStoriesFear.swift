...
class AEStoriesFear: NSObject {
    var storyFear = [AEStory]()
    
    func loadFear(fromURLString: String, completionHandler: (AEStoriesFear, String?) -> Void) {
    ...
    func parse(jsonData: NSData, completionHandler: (AEStoriesFear, String?) -> Void) {
