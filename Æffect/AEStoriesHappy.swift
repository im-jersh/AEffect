...
class AEStoriesHappy: NSObject {
    
    var storyHappy = [AEStory]()
    
    func loadHappy(fromURLString: String, completionHandler: (AEStoriesHappy, String?) -> Void) {
    ...
    func parse(jsonData: NSData, completionHandler: (AEStoriesHappy, String?) -> Void) {
