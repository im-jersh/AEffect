...
class AEStoriesAnger: NSObject {
   
    var storyAnger = [AEStory]()
    
    func loadHappy(fromURLString: String, completionHandler: (AEStoriesAnger, String?) -> Void) {
    ...
    func parse(jsonData: NSData, completionHandler: (AEStoriesAnger, String?) -> Void) {
