...
class AEStoriesSadness: NSObject {
   
    var storySadness = [AEStory]()
    
    func loadSadness(fromURLString: String, completionHandler: (AEStoriesSadness, String?) -> Void) {
        
        storySadness =  [AEStory]()
    ...
    func parse(jsonData: NSData, completionHandler: (AEStoriesSadness, String?) -> Void) {
